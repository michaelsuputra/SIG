...
<head>
  ...
  <title>Sistem Informasi Geograsis</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      <a href="{{ asset('AdminLTE-3.0.5') }}/index3.html" class="navbar-brand">
        <!-- <img src="{{ asset('AdminLTE-3.0.5') }}/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" -->
             <!-- style="opacity: .8"> -->
        <span class="brand-text font-weight-light"> <h3>Sistem Informasi Geografis</h3></span>
      </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Wellcome to SIG</h1>
          </div><!-- /.col -->
